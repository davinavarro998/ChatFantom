//Dados Contrato
//import dataGroup from "../build/contracts/Grupos.json" assert {type: 'json'};
//import dataGroupChat from "../build/contracts/GroupChatImplementation.json" assert {type: 'json'};
...
const contractGroupAddress = "0xaf5FF03aAE346E858c84d824f0a273dB3810A717";
...
const contractGroupChatAddress = "0x74E9a14969b792b3616D62a80fA3e5fac1343C62";
...
let requests = [];
let denyRequests = [];
denyRequests = await getDenyRequests();
let idToAdd;
//\DADOS
